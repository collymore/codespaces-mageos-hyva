<?php
    ...
    class OciService
    {
         ...
         * @return false|array
         */
        public function validateRequest(array $params): bool|array
        {
         ...
         * @return array|string
         */
        public function validateSetupConfiguredParam(array $params): array|string
        {
            $errors = [];
        ...
        {
          return Zend_Validate::is(value: $email,classBaseName:'EmailAddress');
        }
