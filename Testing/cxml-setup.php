<?php
    ...
    $serverLocal = $storeManager->getStore()->getBaseUrl().'develo_punchout/index/cxmlsetup';

    
    $cxml = file_get_contents('posr.xml');
    ...
    echo "<br/></br><h1>Setup Request URL:</h1> " . $serverLocal. "";
