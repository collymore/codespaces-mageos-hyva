        ...
        public function execute()
        {
            try {
                ...
                if (!isset($queryParam->token, $queryParam->user_id)) {
                    return $this->jsonResponse->sendResponse(statusCode: 400,
                        data: 'Access token and user id are required to perform this action');
                }
                ...
                if(!$this->proxyRequestService->isTokenExpired(tokenExpiryDate: $matchingCustomer->getExpiryDate())){
